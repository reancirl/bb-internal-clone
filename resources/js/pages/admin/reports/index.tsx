...
import { BarChart3, ChevronRight, Clock, Download, ExternalLink, Package } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:p-6">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Cross-project financial and operational reporting.</p>
                </div>

                <div className="grid gap-4 sm:grid-cols-2">
                    <Link href="/admin/reports/time-summary" className="group">
                        <Card className="hover:bg-muted/40 h-full transition-colors">
                            <CardHeader>
                                ...
                                <CardDescription>Hours per employee by date range, with CSV export for payroll.</CardDescription>
                            </CardHeader>
                        </Card>
                    </Link>
                    <Link href="/admin/reports/material-status" className="group">
                        <Card className="hover:bg-muted/40 h-full transition-colors">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                ...
                                <CardDescription>Ordered / on-site / outstanding takeoff lines by project and category.</CardDescription>
                            </CardHeader>
                        </Card>
                    </Link>
                </div>
