...
import { CrmUser, Lead, LeadActivity } from '@/types/crm';
...
export default function LeadShow({ lead, activities, users }: LeadShowProps) {
    ...
    const handleSaveActivity = (activity: Omit<LeadActivity, 'id' | 'lead_id' | 'created_by' | 'created_at'>) => {
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <a href={`mailto:${lead.email}`} className="text-sm text-blue-600 hover:underline dark:text-blue-400">
                                            {lead.email}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <a href={`tel:${lead.phone}`} className="text-sm text-blue-600 hover:underline dark:text-blue-400">
                                            {lead.phone}
                                        </a>
                                    </div>
                                </div>
                                ...
                                {lead.build_location && (
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted-foreground text-sm">{lead.build_location}</p>
                                        </div>
                                    </div>
                                )}
                            </CardContent>
                            ...
                            <CardContent className="space-y-4">
                                {lead.project_details && (
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm">{lead.project_details}</p>
                                    </div>
                                )}
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground text-sm capitalize">{lead.source.replace('_', ' ')}</p>
                                    </div>
                                </div>
                                ...
                                {assignedUser && (
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted-foreground text-sm">{assignedUser.name}</p>
                                        </div>
                                    </div>
                                )}
